 ...
 <div class="modal fade" id="viewInfo<?php echo $row["truck"]; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header bg-primary">
                <?php 
                    $sql = "SELECT * FROM vehicles WHERE vehicles.number = '".$row["truck"]."' ";
                    $query = mysqli_query($conn, $sql);
                    $row1 = mysqli_fetch_assoc($query);
                ?>
              <h4 class="modal-title" id="staticBackdropLabel">Truck <?php echo $row1["number"]; ?> </h4>
