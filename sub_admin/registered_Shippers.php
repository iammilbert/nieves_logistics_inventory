...
<html lang="en">
  ...
  <title class="center">Registered Shippers Income</title>
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table" style="font-size:13px;">
                  ...
                  <tbody>
                 <?php
                      $sql="SELECT distinct loads.shipperEmail, loads.shipperAddress FROM loads";
                      ...
                      <tr>
                        ...
                        <td>
                            <a class='btn btn-sm btn-warning text-white' data-toggle='modal' data-target='#'><small><i class='fa fa-edit'></i></small></a> 
