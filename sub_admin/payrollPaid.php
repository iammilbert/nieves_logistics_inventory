...
<html lang="en">
  ...
  <title class="center">Successful Payment</title>
            ...
            <div class="card card-primary card-outline">     
              ...
              <div class="card-body">
               <form class="form">
                 ...
                 <div class="row text-center">
                   <div class="col">
                    <h2><i class="fa fa-arrow-down" style="color:red;"></i></h2>
                   </div>
                 </div>
               </form>
              </div>
                 ...
                 <div class="row text-center">
                   <div class="col">
                     <div class="form-group">
                      <a href="staff_successful_payment.php" class="btn btn-lg btn-primary"><i class="fa fa-users" style="color:black;"></i> Staff</a>
                     </div>
                   </div>
                   <div class="col">
                     <div class="form-group">
                   ...
                   <div class="col">
                     <div class="form-group">
                      <a href="drivers_successful_payment_table.php" class="btn btn-lg btn-success"><i class="fa fa-truck" style="color:black;"></i> Drivers</a>
                     </div>
                   </div>
                 </div>
               </form>
