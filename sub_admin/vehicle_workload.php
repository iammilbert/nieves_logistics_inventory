          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger">VEHICLES WORKLOAD</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table font-size-13">
                  ...
                  <tr>  
                    ...
                    <td>
                      ...
                      <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#vehicle_date_range_report_modal<?php echo $row["id"];?>"><i class="fa fa-eye"></i> Report</a>
