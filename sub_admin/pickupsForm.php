          ...
          <div class="col-md-8">
            <div class="card card-primary card-outline">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="name" id="name" placeholder="Enter Pickup name" required="name">
                        </div>

                   <div class="input-group mb-3">
                          <span for="state" class="input-group-text">Pickup State</span>
                          <input type="text" class="form-control" name="state" id="state" placeholder="Enter Pickup State" required="state">
                        </div>

                       <div class="input-group mb-3">
                          <span for="pickup" class="input-group-text">City</span>
                          <input type="location" class="form-control" name="city" id="city" placeholder="Enter Pickup City" required="city">
                        </div>

                        <div class="input-group mb-3">
                          <span for="address" class="input-group-text">Pickup Address</span>
                          <input type="location" class="form-control" name="address" id="address" placeholder="Enter Pickup address" required="address">
                        </div>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="date" class="form-control" name="date" id="date" placeholder="Enter Pickup date" required="date">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="time" class="form-control" name="time" id="time" placeholder="Enter Pickup time" required="time">
              ...
              <div class="modal-footer justify-content-between">
                <a href="pickupsTable.php?reg=<?php echo $row["id"]; ?>" class="btn btn-danger">Back</a>
