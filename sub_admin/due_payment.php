                 ...
                 <div class="row text-center">
                   <div class="col-md-4">
                     <div class="form-group">
                      <a href="staff_due_payment.php" class="btn btn-lg btn-primary"><i class="fa fa-users" style="color:black;"></i> Staff</a>
                     </div>
                   </div>
                   <div class="col-md-4">
                     <div class="form-group">
                   ...
                   <div class="col-md-4">
                     <div class="form-group">
                      <a href="drivers_due_payment.php" class="btn btn-lg btn-success"><i class="fa fa-truck" style="color:black;"></i> Drivers</a>
                     </div>
                   </div>
                 </div>
               </form>
