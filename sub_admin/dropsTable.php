          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;">Drops Information</b></h3>
              </div>
               <div class="card-header ml-auto">
                <a href="dropsForm.php?reg=<?php echo $row["id"]; ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Drop</a>
                </div>
             ...
             <table id="example1" class="table" style="font-size:13px;">
                ...
                <?php
                      $sql = "SELECT * FROM drops WHERE drops.load_id = '".$id."'";
                   ...
                   <?php    
                   include 'edit_drops.php';  
                   include 'drops_delete_form.php';                  
