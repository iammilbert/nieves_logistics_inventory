...
<div class="modal fade" id="vehicle_update_Modal<?php echo $row['id']?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="card-body">
                     <div class="input-group mb-3">
                        ...
                        <select class="form-select form-control" name="vehicleType">
                          <option selected value="<?php echo $row["vehicleType"]; ?>"><?php echo $row["vehicleType"]; ?></option>
                          <option value="Truck">Truck</option>
                          <option value="Trailer">Trailer</option>
                          <option value="Trailer">Tractor</option>
                      </select>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="plateNumber" class="form-control" value="<?php echo $row['plateNumber']?>"/>
                  </div>
