            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table font-size-13">
                  ...
                  $sql = "SELECT loads_assigned.driver_id, loads.brokerEmail, loads_assigned.id, loads_assigned.load_id, loads.brokerNumber, loads.shipperEmail, loads.brokerName, loads.totalPickups, loads.totalDrops, loads.totalLoadPicked, loads.totalLoadDropped, loads_assigned.id AS loadAssignedID, loads.rateConfirmationID, users.name, loads_assigned.status, users.licenseID, loads.rate FROM loads
                    INNER JOIN users
