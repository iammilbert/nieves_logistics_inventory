...
<html lang="en">
  ...
  <title class="center">Register Loads</title>
   ...
   <li class="nav-item">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="registered_Load.php" class="nav-link active">
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title bold text-danger">REGISTERED LOADS</h3>
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                   <?php
                    ...
                    ?>
                      ...
                      <td>  
                      <?php 
                         if($row["totalPickups"]==$row["totalLoadPicked"] AND $row["totalDrops"] == $row["totalLoadDropped"] AND $row["pickedupTime"] != 0 AND $row["droppedTime"] != 0 AND $row["totalDrops"] != 0 AND $row["totalPickups"] != 0 ){
                        echo "<small class='badge badge-success'>Delivered</small>";
                      }

                         elseif($row["totalPickups"]==$row["totalLoadPicked"] AND $row["totalDrops"] == $row["totalLoadDropped"] AND $row["pickedupTime"] == 0 AND $row["droppedTime"] == 0 AND $row["totalDrops"] != 0 AND $row["totalPickups"] != 0 ){
                        ...
                        elseif ($row["status"]==2) {
                          ...
                          elseif ($row["status"]==1) {
                          echo "<small class='badge badge-primary'>Assigned</small>"; 
                        }
                         else
