  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
             ...
             <div class="row">
              <table class="table table-striped table-bordered">
                  ...
                  <tr>
              	 ...
              	 <?php if($row5["status"]==0)
              	 { 
              	 echo "<a class='btn btn-success text-white' data-toggle='modal' data-target='#makePayment'>Pay Now</a>
              	 <a class='btn btn-info' href='editpayRollForm.php?staffId={$row6["id"]}'><i class='fa fa-edit'></i></a>"; 
              	 }
              	 ?>
              </div>
              <!-- /.card-body -->
        ...
        <div class="modal fade" id="makePayment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
      ...
      <form class="form" action="makePayment_query.php" method="POST">
                ...
                <div class="input-group mb-3">
                 <div class="input-group-append">
                  ...
                  <input type="text" name="name" class="form-control" readonly value="<?php echo $row6["name"]; ?>">
                  <input type="hidden" name="lastPaymentMonth" class="form-control" value="<?php echo $row5["months"]; ?>">
                  <input type="text" name="staffID" class="form-control" readonly value="<?php echo $row6["id"]; ?>">
                  <input type="hidden" name="paidSlipID" class="form-control" value="<?php echo $payRollSlip; ?>"> 
                  <input type="hidden" name="status" class="form-control" value="1"> 
                  <input type="hidden" name="payRollStatus" class="form-control" value="0"> 
                ...
                <div class="input-group mb-3">
                 <div class="input-group-append">
                  ...
                  <input style="text-align:right;" type="text" name="months" class="form-control" readonly value="<?php echo $row5["months"]; ?>">  
                   <div class="input-group-append">
                    <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                 <div class="input-group-append">
                  ...
                  <input style="text-align:right;" type="text" class="form-control bold font-size-28" readonly value="<?php echo number_format($TOTAL, 2, '.', ',');?>">

                   <input type="hidden" name="amountPaid" value="<?php echo $TOTAL; ?>"> 
              ...
              <div class="modal-footer justify-content-between ">
                  <button type="button" class="btn btn-danger" data-dismiss="modal"><span class="fas fa-close">Cancel</span></button>
                    ...
                    <input type="submit" name="pay" class="btn btn-success" value="Proceed">
              </div>
