 ...
 <div class="modal fade" id="viewTrailer<?php echo $row["trailer"]; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header bg-primary">
                <?php 
                    $sql = "SELECT * FROM vehicles WHERE vehicles.number = '".$row["trailer"]."' ";
                    $query = mysqli_query($conn, $sql);
                    $row1 = mysqli_fetch_assoc($query);
                ?>
              <h4 class="modal-title" id="staticBackdropLabel">Trailer <?php echo $row1["number"]; ?> </h4>
