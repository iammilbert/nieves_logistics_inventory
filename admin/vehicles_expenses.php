          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">VEHICLES</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                   ...
                   <?php
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="view_vehicle_expenses_page.php?vehicleNumber=<?php echo $row["number"]; ?>" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> History</a>
                        </td>
                      </tr>
