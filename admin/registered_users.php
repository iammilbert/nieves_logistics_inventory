       ...
       <div class="dropdown show nav-item d-none d-sm-inline-block" >
        ...
        <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkUsers">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="registered_users.php">Registered Usres</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="company_info.php">Company Info</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="inbox.php">Message Inbox</a>
              ...
              <div class="card-body">
                <table id="example2" class="table font-size-13">
                  ...
                  <tbody>
                    ...
                    $empty = " ";
                    $empty2 = NULL;
                       $sql="SELECT * FROM users WHERE role = '".$Staff."' OR role = '".$empty."' = role = '".$empty2."' ";
