...
<?php
 $userID = isset($_GET['staffId']) ? $_GET['staffId'] : '';
 ...
 <!-- Content Wrapper. Contains page content -->
        ...
        <div class="row mb-2">
          <div class="col">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="staff_due_payment.php" class="btn btn-sm btn-danger"><i class="fa fa-backward"></i> Back</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
         ...
         <script type="text/javascript">
                          function allowee(that) 
                          {
                            if (that.value == "Yes") 
                              {
                                  document.getElementById("dataA").style.display = "block";
                                  document.getElementById("incentiveA").style.display = "block";
                                  document.getElementById("medicalA").style.display = "block";
                                 
                              }
                              else
                              {
                                   document.getElementById("dataA").style.display = "none";
                                  document.getElementById("incentiveA").style.display = "none";
                                  document.getElementById("medicalA").style.display = "none";
                              }
          ...
          <div class="col">
            <div class="card card-primary card-sm card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;"><?php echo $row5["name"]; ?></b> >>> Pay Roll</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              
  <form method="POST" action="payRollFormQuery.php">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputBasic">Basic Salary</label>
      <input type="number" class="form-control" id="inputBasic" placeholder="Basic Salary" name="amount">
    </div>
    <div class="form-group col-md-6">
      <label for="inputMonth">Month</label>
      <input type="month" class="form-control" id="inputMonth" placeholder="Month" name="months">
    </div>
  </div>
  
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputIncrease">increment</label>
      <input type="number" class="form-control" id="inputIncrease" placeholder="Salary Increment" name="increment">
    </div>
    <div class="form-group col-md-6">
      <label for="inputDeduction">Deduction</label>
      <select id="inputState" class="form-control" onchange="YesNo(this);">
      ...
      <div class="form-row">
    <div class="form-group col-md-6" style="display:none;" id="amountD">
      <label for="deduction">Amount Deducted</label>
      <input type="number" class="form-control" id="deduction" placeholder="Amount Deducted" name="deduction">
    </div>
    <div class="form-group col-md-6" id="reasonD" style="display:none;">
      <label for="deductionReason">Reasons for Deduction</label>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="inputTax" name="tax">
       <input type="hidden" class="form-control" id="inputTax" name="staff_id" value="<?php echo $userID; ?>">
       
        <input type="hidden" class="form-control" id="inputTax" name="prepaidBy" value="<?php echo $_SESSION["id"]; ?>">
        
        <input type="hidden" class="form-control" id="inputTax" name="payRollStatus" value="1">
    </div>


    <div class="form-group col-md-6">
      <label for="inputAllowance">Allowance</label>
         <select id="inputIncentive" class="form-control" onchange="allowee(this);">
        <option disabled selected>--Yes/No--</option>
        <option value="Yes">Yes</option>
        <option value="No">No</option>
      </select>
    ...
    <div class="form-row">
    <div class="form-group col-md-4" id="dataA" style="display:none;">
      <label for="inputTax">Data</label>
      <input type="number" class="form-control" id="inputTax" name="dataAllowance">
    </div>
    <div class="form-group col-md-4" id="medicalA" style="display:none;">
      <label for="inputMedical">Medical</label>
      <input type="number" class="form-control" id="inputMedical" name="medicalAllowance">
    </div>
    
        <div class="form-group col-md-4" id="incentiveA" style="display:none;">
      <label for="inputIncentive">Incentive</label>
   <input type="number" class="form-control" id="inputIncentive" name="incentive">
    </div>
  </div>
  <div class="form-group">
    <div class="form-check">
      <input class="form-check-input" type="checkbox" id="gridCheck" required="agree" name="agree">
