	...
	if ($error ===0) {
		if ($img_size > 1250000) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
				...
				$sql = "UPDATE companyinfo SET logo = '".$new_img_name."'";
          ...
          <div class="col">
            <div class="card card-danger card-outline">
              <div class="card-header bg-info">
                <h3 class="card-title"><b style="color:white;">Company Logo</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                          <label for="logo" class="input-group-text">Logo upload</label>
