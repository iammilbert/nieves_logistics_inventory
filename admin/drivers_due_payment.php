          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;">DRIVERS DUE FOR PAYMENT</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <td><small class="badge badge-info"><?php echo $row['name']?></small></td>
                         ...
                         <td>
                            ...
                            <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#date_range_report<?php echo $row["id"];?>"><small><b>Make Payment</b></small></a>
