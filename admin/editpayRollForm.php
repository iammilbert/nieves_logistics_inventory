...
<?php
$sql6 = "SELECT * FROM staff_salaries WHERE staff_salaries.staff_id = '".$userID."'";
          ...
          <div class="col">
            <div class="card card-primary card-sm card-outline">
              <div class="card-header">
                <h3 class="card-title"><b>Editing <?php echo $row5["name"]; ?></b> Pay Roll</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              
  <form method="POST" action="editpayRollFormQuery.php">
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputBasic">Basic Salary</label>
      <input type="number" class="form-control" id="inputBasic" value="<?php echo $row6["amount"]; ?>" name="amount">
    </div>
    <div class="form-group col-md-4">
      <label for="inputMonth">Month</label>
      <input type="month" class="form-control" id="inputMonth"  value="<?php echo $row6["months"]; ?>" name="months">
    </div>

    <div class="form-group col-md-4">
      <label for="inputIncrease">increment</label>
      <input type="number" class="form-control" id="inputIncrease"  value="<?php echo $row6["increment"]; ?>" name="increment">
    </div>
  </div>

  <label><h5 style="font-weight: bolder;"><u>DEDUCTIONS</u></h5></label>
  <div class="form-row">
   <div class="form-group col-md-4">
      <label for="inputTax">Tax</label>
      <input type="number" class="form-control" id="inputTax" name="tax"  value="<?php echo $row6["tax"]; ?>">
       <input type="hidden" class="form-control" id="inputTax" name="staff_id" value="<?php echo $userID; ?>">        
    </div>

     <div class="form-group col-md-4" id="amountD">
      <label for="deduction">Other</label>
      <input type="number" class="form-control" id="deduction"  value="<?php echo $row6["deduction"]; ?>" name="deduction">
    </div>

   <div class="form-group col-md-4" id="reasonD">
      <label for="deductionReason">Reasons for Other</label>
      <textarea name="reason" class="form-control" id="reason" placeholder="Reason.."><?php echo $row6["reason"]; ?></textarea>
    </div>
  </div>

<label><h5 style="font-weight: bolder;"><u>ALLOWANCES</u></h5></label>
    <div class="form-row">
    <div class="form-group col-md-4" id="dataA">
      <label for="inputTax">Data Allowance</label>
      <input type="number" class="form-control" id="inputTax" name="dataAllowance"  value="<?php echo $row6["dataAllowance"]; ?>">
    </div>
    <div class="form-group col-md-4" id="medicalA">
      <label for="inputMedical">Medical</label>
      <input type="number" class="form-control" id="inputMedical" name="medicalAllowance" value="<?php echo $row6["medicalAllowance"]; ?>">
    </div>
    
        <div class="form-group col-md-4" id="incentiveA">
      <label for="inputIncentive">Incentive</label>
   <input type="number" class="form-control" id="inputIncentive" name="incentive" value="<?php echo $row6["incentive"]; ?>">
    </div>
  </div>
