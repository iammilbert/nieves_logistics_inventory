...
<html lang="en">
  ...
  <title class="center">Staff Payment</title>
    ...
    <ul class="navbar-nav" style="font-weight:bolder;">
      ...
      <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkPayout">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item active" href="payrollPaid.php">Successful Payment</a>
          </div>
        </div>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger"><b>PAYMENT SUCCESSFUL</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table font-size-13">
                  ...
                  <tbody>
                      ...
                      $sql="SELECT users.name, users.id, staff_salaries.months, staff_salaries.datePaid, staff_salaries.timePaid, users.tel, users.email, users.role, staff_salaries.amount FROM staff_salaries
                      INNER JOIN users 
                      ...
                      <tr>
                        ...
                        <td><?php $months = new DateTime($row["months"]); echo $months->format('M-Y'); ?></td>
                        <td><b class="text-danger"><?php echo $row['datePaid']; ?></b> <b class="text-green bold"><?php echo $row['timePaid']; ?></b></td>
                        <td><b class="bold">NGN </b><?php echo number_format($row['amount'], 2, '.', ','); ?></td>
