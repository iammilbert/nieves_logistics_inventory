    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- New row -->
          <div class="row">
          <div class="col">
              <h5 class="text-center"><b style="color:red;">COMPANY EXPENSES</b></h5>
            ...
            <div class="card card-primary card-outline">
              <div class="modal-header">             
                    ...
                    <?php 
                      $sql2 = "SELECT SUM(drops.amount_Spent) AS sum FROM drops";
                      $query2 = mysqli_query($conn, $sql2);
                      $row2 = mysqli_fetch_assoc($query2);
                    ?>

                    <h6 ><b>TOTAL AMOUNT</b> : <?php echo $row2["sum"]; ?><sup style="font-weight:bolder; color:green;">USD</sup></h6>
              </div>
              <div class="card-body">
                <table id="example1" class="table" style="font-size:13px;">
                  ...
                  if (isset($_POST["generate"])) {
                      ...
                      $sql="SELECT * FROM drops WHERE drops.dropped_Date  BETWEEN '".$startDate."' AND '".$endDate."'";
                      ...
                      <tr>
                         ...
                         <td><a class="deletebtn" name="delete" style="font-size:15px; font-weight: bolder;"><?php echo $row['expenses_Type']; ?></a></td>
                        <td><?php echo $row['expenses_Description']; ?></td>
                        <td><?php echo $row['amount_Spent']; ?></td>
                        <td><?php echo $row['driver_id']; ?></td>
                        
                        <td>
                          <button class="btn btn-sm btn-primary"data-toggle="modal" type="button" data-target="#update_modal<?php echo $row['id']?>"><span class="fas fa-eye"></span></button>
