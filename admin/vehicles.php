                  ...
                  <tbody>
                   ...
                   $no = 1;
                      ...
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-sm btn-primary"data-toggle="modal" type="button" data-target="#vehicle_update_Modal<?php echo $row['id']?>"><span class="fas fa-edit"></span></button>
                           ...
                           <button class="btn btn-sm btn-danger"data-toggle="modal" type="button" data-target="#vehicle_delete<?php echo $row['id']?>"><span class="fas fa-trash"></span></button>
                           <a class="btn btn-sm btn-warning" data-toggle="modal" data-target=""><i class="fa fa-eye"></i> Explore</a>
                    ...
                    <?php                      
                     ...
                     include 'vehicle_delete_modal.php';
                     $no++;
                      }
                    ?>
                  </tbody>
                ...
                <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                         ...
                         <div class="input-group mb-3">
                           ...
                           <input type="text" class="form-control" name="plateNumber" placeholder="License Plate Number">
