      ...
      <div class="container-fluid">
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">VEHICLES ASSIGNED</h3>
              </div>
              <div class="card-body">
        ...
        <table id="example1" class="table font-size-13">
                  ...
                  <tbody>
                      ...
                      WHERE loads.totalLoadDropped < loads.totalDrops || loads.totalLoadPicked < loads.totalPickups || loads.totalLoadDropped < loads.totalDrops AND loads.totalLoadPicked < loads.totalPickups AND loads.registeredBy = '".$id."' || loads.totalLoadDropped = loads.totalDrops AND loads.totalLoadPicked < loads.totalPickups || loads.totalLoadDropped < loads.totalDrops AND loads.totalLoadPicked = loads.totalPickups || loads.totalPickups > loads.totalLoadPicked AND loads.totalDrops > loads.totalLoadDropped";
