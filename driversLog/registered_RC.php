        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="registered_RC.php" class="nav-link active">
                  <i class="fas fa-users nav-icon"></i>
                  <p>ALL RC </p>
                </a>
              </li>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header bg-success">
                <h3 class="card-title"><b style="color:white;">RATE CONFIRMATION REGISTERED</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               ...
               <table id="example2" class="table font-size-14">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT users.name, driversLog.rateConfirmationID, driversLog.comment, driversLog.id FROM driversLog
                    INNER JOIN users 
                    ON driversLog.driverID = users.id";
                  ...
                  <tr>
                    <td><?php echo $row["rateConfirmationID"]; ?></td>
                      ...
                      <td><i><a href='downloads.php?file_id=<?php echo $row['id']; ?>' target='_blank'> Download RC</a></i></td>  

                      <td> 
                          <a href="editDriverLog.php?id=<?php echo $row["id"];?>" class="btn btn-sm btn-warning text-white font-weight-bold"><i class="fa fa-edit text-white"></i> RC</a>
