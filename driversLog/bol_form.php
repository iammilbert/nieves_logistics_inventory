          ...
          <div class="col-md-8">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">RATE CONFIRMATION UPLOAD</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                          ...
                          <div class="form-group">
                             <label for="rateConfirmationID">Rate Confirmation ID</label>
                              <input type="text" id="rateConfirmationID" name="rateConfirmationID" class="form-control">                                   
                          </div>
                            ...
                            <div class="form-group">
                               <label>RC File</label>
                               <input type="file" name="rateConfirmation" id="rateConfirmation" class="form-control">
                             </div>
