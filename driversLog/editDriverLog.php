...
<?php 
 ...
 $sql = "SELECT * FROM driversLog WHERE id = '".$id."'"; 
          ...
          <div class="col-md-8">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger font-weight-bold">RATE CONFIRMATION UPLOAD</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                          <form method="POST" action="editDriverLogQuery.php" enctype="multipart/form-data" >
                              <input type="hidden" class="form-control" name="date_uploaded" value="<?php echo date("Y-m-d");?>">
                              <input type="hidden" class="form-control" name="uploadedBy" value="<?php echo $_SESSION["DOTID"]; ?>">
                          ...
                          <div class="form-group">
                             <label for="rateConfirmationID">Rate Confirmation ID</label>
                              <input type="text" id="rateConfirmationID" name="rateConfirmationID" class="form-control" value="<?php echo $row55["rateConfirmationID"]; ?>" >                                   
                          </div>
                            ...
                            <div class="form-group">
                               <label>RC File</label>
                               <input type="file" name="rateConfirmation" id="rateConfirmation" class="form-control" required="rateConfirmation">
                             </div>
