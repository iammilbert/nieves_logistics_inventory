...
<html lang="en">
  ...
  <title class="center">Drivers Paid</title>
...
?>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <a href="drivers_successful_payment_table.php" class="btn btn-danger btn-sm">Go Back</a>
           </div>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;"><?php echo $row2["name"]; ?></b> <b>LOADS</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
