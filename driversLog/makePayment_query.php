...
include '../config.php';
    ...
    if ($query) {
             echo '<script> alert("Payment Successfully"); window.location.href = "drivers_due_payment.php";</script>';
             
           }else { 
                echo '<script> alert("Unknown error occurred. Please reassign"); window.location.href = "drivers_due_payment.php";</script>';
