        ...
        <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkReport">
            ...
            <a class="dropdown-item" href="registered_Expenditures.php">Expenditures</a>
             <div class="dropdown-divider"></div>
            <a class="dropdown-item active" href="payout_report.php.php">Pay Out</a>
            <div class="dropdown-divider"></div>
                 ...
                 <div class="row text-center">
                   <div class="col">
                     <div class="form-group">
                      <a href="staff_payment_report.php" class="btn btn-lg btn-primary"><i class="fa fa-users" style="color:black;"></i> Staff Report</a>
                     </div>
                   </div>
                   <div class="col">
                     <div class="form-group">
                   ...
                   <div class="col">
                     <div class="form-group">
                      <a href="drivers_payment_report.php" class="btn btn-lg btn-success"><i class="fa fa-truck" style="color:black;"></i> Drivers Report</a>
                     </div>
                   </div>
                 </div>
               </form>
