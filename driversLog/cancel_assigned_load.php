...
$loadID = isset($_GET["loadID"]) ? $_GET["loadID"] : '';
 ...
 $sql = "SELECT * FROM vehicles_assigned WHERE load_id = '".$loadID."' "; 
 $query = mysqli_query($conn, $sql); 
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">CANCELLING LOADS COMPLETELY</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST" action="cancel_assigned_load_query.php">
                        ...
                        <input type="hidden" name="pickedup_Date" value="<?php echo date("Y-m-d") ?>">
                             ...
                             <input type="hidden" name="truck" value="<?php echo $row1["truck"]; ?>">
                             <input type="hidden" name="trailer" value="<?php echo $row1["trailer"]; ?>">
                             <input type="hidden" name="tractor" value="<?php echo $row1["tractor"]; ?>">
