       ...
       <div class="dropdown show nav-item d-none d-sm-inline-block" >
        ...
        <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkReport">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item active" href="registered_Shippers.php">Registered Shippers</a>
            <div class="dropdown-divider"></div>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="registered_Shippers.php" class="nav-link active">
                  <i class="fas fa-users nav-icon"></i>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;">REGISTERED SHIPPERS</b></h3>
              </div>
              <div class="card-body">
                ...
                <table id="example1" class="table" style="font-size:13px;">
                  ...
                  <tbody>
                      ...
                      $sql="SELECT distinct loads.shipperName, loads.shipperTel, loads.shipperEmail, loads.shipperAddress FROM loads";
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['shipperEmail']; ?></td>
                        <td><?php echo $row['shipperTel']; ?></td>
                        <td><?php echo $row['shipperAddress']; ?></td>
