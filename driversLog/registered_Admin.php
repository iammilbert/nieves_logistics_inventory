       ...
       <div class="dropdown show nav-item d-none d-sm-inline-block" >
        ...
        <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkReport">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item active" href="registered_Admin.php">Registered Admin</a>
            <div class="dropdown-divider"></div>
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="registered_Shippers.php" class="nav-link">
                 ...
                 <li class="nav-item">
                <a href="registered_Admin.php" class="nav-link active">
                  <i class="fas fa-users nav-icon"></i>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">REGISTERED ADMIN</h3>
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="print_users_profile.php?userID=<?php echo $row["id"]; ?>" class="btn btn-primary btn"><i class="fas fa-eye"></i></a>
