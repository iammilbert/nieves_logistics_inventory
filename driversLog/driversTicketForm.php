          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="driversTicketForm.php" class="nav-link active">
                  <i class="fas fa-shipping-fast nav-icon"></i>
                  <p>Upload Ticket</p>
                </a>
              </li>
          ...
          <div class="col-md-8">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">TICKET UPLOAD</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                          <form method="POST" action="ticket_form_query.php" enctype="multipart/form-data" >
                          ...
                          <div class="form-group">
                             <label for="fileName">Ticket Name</label>
                            ...
                            <div class="form-group">
                               <label>Ticket </label>  (zip, pdf, docx)
                               <input type="file" name="ticket" id="ticket" class="form-control">
                             </div>
