...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav bold">
      ...
      <div class="dropdown show nav-item d-none d-sm-inline-block n" >
          <a class="btn btn-sm dropdown-toggle navv" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-weight:bolder; color: steelblue;" onMouseOver="this.style.color='white'" onMouseOut="this.style.color='steelblue'"><span class="navv">PICKUPS</span></a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active bold">
            ...
            <div class="car card-primary">
              ...
              <form class="form" method="POST" action="load.php">
                ...
                <div class="col-md-6"> 
                     ...
                     <div class="input-group mb-3">
                      <input type="hidden" name="shipperEmail" class="form-control" id="shipperEmail" placeholder="Enter Shipper Email">
                    </div>

                    <div class="input-group mb-3">
                      <input type="hidden" name="shipperAddress" id="shipperAddress" class="form-control" placeholder="Enter Shipper Address">
