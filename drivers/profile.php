...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="workload" role="button" data-toggle="dropdown" aria-expanded="false" style="font-weight:bolder;"> PAY ROLL
        </a>
          ...
          <div class="col">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="profile-username text-center bold font-size-13"><i class="fas fa-map-marker-alt mr-1 text-danger"></i><?php echo $row["address"]; ?></p>
