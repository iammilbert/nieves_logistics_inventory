        ...
        <div class="row mb-2">
          <div class="col-sm-6 ml-auto">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="load_assigned.php">Back</a></li>
            ...
            <div class="card card-danger card-outline">
             ...
             <table id="example1" class="table font-size-13">
               ...
               <?php
                  ...
                  $sql = "SELECT loads.rateConfirmationID, pickups.id, pickups.time, pickups.date, pickups.pickedStatus, loads.loadDescription, loads.dateRegistered, pickups.address, pickups.state, pickups.stateZipCode, pickups.city, loads.driver_id, pickups.load_id, pickups.name FROM pickups
                  INNER JOIN loads
                  ON pickups.load_id = loads.id
                  WHERE pickups.driver_id = '".$myID."' AND pickups.load_id = '".$load_id."' ORDER BY loads.dateRegistered DESC";
                  ...
                  while ($row = mysqli_fetch_assoc($query)){
                      ...
                      <tr>
                         <td><?php echo $row['rateConfirmationID']; ?></td>
                          ...
                          <td><?php echo $row['address']; ?>, <br><?php echo $row['state']; ?> <br><?php echo $row['city']; ?> <?php echo $row['stateZipCode']; ?></td>
