      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="editProfile.php"><i class="fa fa-cog"></i> Edit Profile</a>
             <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="myPayroll.php"><i class="fa fa-cog"></i> My Payroll</a>
        </div>
      </li>
    </ul>
    </div>
...
<?php
   ...
   ?>
                  <div class="text-center bold">
                   <h3 class="name bold"><?php echo $row4["name"];?></h3>     
                  </div>
                      ...
                      <div class="col font-size-13">
                         <form class="form tahoma">
                          <div class="form-group">
                            ...
                            <span><b>ID #:</b> <?php echo $row2["id"]; ?></span> <br>
                      ...
                      <div class="col font-size-13">
                          <form class="form tahoma">
                            <div class="form-group">
                              ...
                              <span><b>Acount Name :</b> <?php echo $row2["accountName"]; ?></span><br>
                        ...
                        <div class="col font-size-13">
                          <form class="form tahoma">
                            <div class="form-group">
                              ...
                              <span><b>Role :</b> <?php echo $row2["role"]; ?></span>
