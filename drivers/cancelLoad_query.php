...
include '../config.php';
    ...
    if (isset($_POST['cancel'])) {
        ...
        if ($updateQuery2) {
               echo '<script> alert("Pickup Successfully Cancelled"); window.location.href = "pickLoadTable.php";</script>';

           
           }else {
             echo '<script> alert("Unknown error occurred. Please try again."); window.location.href = "pickLoadTable.php";</script>';
