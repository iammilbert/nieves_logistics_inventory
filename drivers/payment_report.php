  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="workload">
          ...
          <div class="dropdown-divider" ></div>
          <a class="dropdown-item active" href="payment_report.php">Payment Report</a>
               <div class="dropdown-divider" ></div>
       ...
       <div class="nav-item" id="ex2">
          <span class="fa-stack has-badge" data-count="9">      
            <i class="fa fa-bell fa-stack-1x fa-inverse font-size-20"><sup></sup></i>
          </span>
      </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- New row -->
          <div class="row">
          <div class="col">
              <h5 class="text-center text-green bold">MY PAYMENT REPORTS</h5>
                  ...
                  if (isset($_POST["generate"])) {
                      ...
                      <tr>
                         ...
                         <td><?php echo $row['startDate']; ?> - <?php echo $row['endDate']; ?></td>
                          <td><?php echo number_format($row['amountPaid'], 2, '.', ','); ?><sup class="text-green bold">USD</sup></td>
