               ...
               echo "<form action='delete_load_query.php' method='POST'>
                   <div class='modal-body'>
                    ...
                    <div class='modal-footer justify-content-between'>
                        <a href='pickupsTable.php?loadID={$row["id"]}' class='btn btn-sm btn-primary'><i class='fa fa-plus'></i> Pickups</a>
                        <p>Rate Confirmation: #{$row["rateConfirmationID"]}</p>
                       <a href='dropsTable.php?loadID={$row["id"]}' class='btn btn-sm btn-primary'><i class='fa fa-plus'></i> Drops</a>
                    </div>
                </form>";
