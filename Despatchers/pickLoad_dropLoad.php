                 ...
                 <form class="form">
                   <div class='modal-body'>
                    ...
                    <div class='modal-footer justify-content-between'>
                        <a href="pickLoadTable.php?load_id=<?php echo $row["load_id"]?>" class="btn btn-sm btn-primary"> Pickup Load</a>
                        
                        <p>Rate Confirmation: #<?php echo $row["rateConfirmationID"]; ?></p>
                       <a href="dropLoadTable.php?load_id=<?php echo $row["load_id"]?>" class="btn btn-sm btn-danger">Drop Pickups</a>
                    </div>
                </form>
            </div>
        </div>
