        ...
        <div class="row mb-2">
          <div class="col-sm-6 ml-auto">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="load.php" class="btn btn-danger btn-sm">Back</a></li>
                    ...
                    <div class="col-md-6">
                      <div class="input-group mb-3">
                         ...
                         <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="name" id="name" placeholder="Enter Drop name">
                        </div>

                         <div class="input-group mb-3">
                          <span for="state" class="input-group-text">Delivery State</span>
                          <input type="text" class="form-control" name="state" id="state" placeholder="Enter Delivery State">
                        </div>

                       <div class="input-group mb-3">
                          <span for="city" class="input-group-text">City</span>
                          <input type="location" class="form-control" name="city" id="city" placeholder="Enter Drop City">
                        </div>

                        <div class="input-group mb-3">
                          <span for="address" class="input-group-text">Drop Address</span>
                          <input type="location" class="form-control" name="address" id="address" placeholder="Enter Drop address">
                        </div>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="date" class="form-control" name="date" id="date" placeholder="Enter Drop date">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="time" class="form-control" name="time" id="time" placeholder="Enter Drop time">
