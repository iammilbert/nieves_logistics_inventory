...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
      <span class="brand-text font-weight-light"><b class="name bold"><?php echo $row4["name"]; ?></b></span>
    </a>
...
<?php
   ...
   <!-- dispatcher Query -->
   <?php
   $sqlmy = "SELECT * FROM users WHERE id = '".$myID."' ";
...
<p></p>
      ...
      ?>
                ...
                <a href="loadDetails.php?id=<?php echo $id; ?>" class="btn btn-warning no-print"><i class="fa fa-print"></i> Back</a> 
                  <a href="load_print.php?id=<?php echo $id; ?>" class="btn btn-warning no-print"><i class="fa fa-print"></i> Print</a> 
                </div>
              </div>
              </div>
            <!-- /.card -->
