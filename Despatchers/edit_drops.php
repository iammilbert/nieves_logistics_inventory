        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header bg-primary">
              <h4 class="modal-title" id="staticBackdropLabel">Editing Drop</h4>
...
?>
                <form method="POST" action="edit_drops_query.php">
                <div class="card-body"> 
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="state" id="state" placeholder="Enter Delivery State" value="<?php echo $row["state"]; ?>">
                        </div>
                       ...
                       <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                          <span for="address" class="input-group-text">Delivery Address</span>
                        ...
                        <div class="input-group mb-3">
                          <span for="date" class="input-group-text">Delivery Date</span>
                        ...
                        <div class="input-group mb-3">
                          <span for="time" class="input-group-text">Delivery Time</span>
