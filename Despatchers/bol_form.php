          ...
          <div class="col-md-8">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title text-danger bold">BILL OF LANDING (BOL PAPER WORK) UPLOAD</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                          <form method="POST" action="bol_form_query.php" enctype="multipart/form-data" >
                              ...
                              <input type="hidden" class="form-control" name="load_id" value="<?php echo $row55["id"]; ?>">
                          ...
                          <div class="form-group">
                             <label for="rateConfirmationID">Rate Confirmation</label>
                              <input type="text" id="rateConfirmationID" name="rateConfirmationID" class="form-control" value="<?php echo $row55["rateConfirmationID"];?>" readonly>                                   
                          </div>
