        ...
        <div class="row mb-2">
          <div class="col-sm-6 ml-auto">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="vehicle_list.php" class="text-danger">Back</a></li>
...
<?php
 $sql = "SELECT * FROM vehicles WHERE vehicles.number = '".$vehicleID."'";  
...
<?php
 $sql = "SELECT * FROM expenses WHERE expenses.truck = '".$vehicleID."' OR expenses.trailer = '".$vehicleID."' OR expenses.tractor = '".$vehicleID."' ";  
 $query = mysqli_query($conn, $sql) or die(mysqli_error($conn)); 
 $row4 = mysqli_fetch_assoc($query);
    ...
    <section class="content">
          ...
          <div class="col">
            <div class="card card-primary card-outline">
                ...
                <h3 class="card-title bold"> <b class="text-danger"><?php echo $row5["vehicleType"]; ?> <?php echo $row5["number"]; ?> </b> Expenditures</h3>
              </div>
              <div class="card-body">
