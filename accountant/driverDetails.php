...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light bold"><b class="name bold"><?php echo $row4["name"];?></b>
        </span>
    </a>
...
?>
                      ...
                      ?>
                        ...
                        <div class="col">
                          ...
                          <div class="form-group">
                            ...
                            <span class="font-size-13"><b>Company :</b> <?php echo $row4["name"]; ?></span><br>
                            <span class="font-size-13"><b>Address :</b> <?php echo $row4["address"]; ?> <?php echo $row4["zipCode"]; ?></span>
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="row">
                           <label class="form-control bg-info font-size-13">PAYMENT</label>
                          <div class="col">
                          ...
                          $row_allowance = mysqli_fetch_assoc($query_allowance);
                            ...
                            ?> 
                                <tr>
                                  <th>Net Pay :</th><td><?php echo $row["netPay"]; ?><sup class="bold text-green">USD</sup></td>
                                </tr>
                                <tr>
                                <th>Expenses :</th><td><?php echo $row_expenses["amount_Spent"]; ?> <sup class="text-green bold">USD</sup></td>
                                </tr>

                                <tr>
                                <th>Date Allowance :</th><td><?php echo $row_allowance["dataAllowance"]; ?> <sup class="text-green bold">USD</sup></td>
                                </tr>
                                ...
                                <th>Medical Allowance :</th><td><?php echo $row_allowance["medicalAllowance"]; ?></td>
                                 ...
                                 <tr>
                                <th>Tax :</th><td><?php echo $row_allowance["tax"]; ?> <sup class="text-green bold">USD</sup></td>
                                </tr>
                          ...
                          <div class="col-md-6">
                                ...
                                <table id="DriverAvailable1" class="table font-size-13">
                                  <h4 class="form-control bg-info font-size-13 bold">DROPS</h4>
                                   <thead class="text-black font-size-11">
                                  <tr>
                                    <th>Name</th>
                                    <th>Date/Time</th>
                                    <th>City/State Zip</th>
              ...
              <div class="modal-footer">
                  <a href="driverDetails_Print.php?id=<?php echo $loadID; ?>" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>
