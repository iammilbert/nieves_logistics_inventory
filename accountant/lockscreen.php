    ...
    if (isset($_POST['login'])) {
     ...
     $result = mysqli_query($conn, $sql);
       ...
       if (mysqli_num_rows($result) == 1) {
          ...
          if ($row["role"] == 'Accountant' && $row["id"] == $id) {
            ...
            echo '<script> alert("Incorrect Password, try again"); window.location.href = "lockscreen.php";</script>';
          }
}
  ?>
...
<div class="lockscreen-wrapper">
  ...
  <!-- User name -->
  <div class="lockscreen-name"><?php $name = $row['name']; echo strtok($name, " "); ?> ...</div>

  <!-- START LOCK SCREEN ITEM -->
  <div class="lockscreen-item">
    <!-- lockscreen image -->
    <div class="lockscreen-image">
      <img class="profile-user-img img-fluid img-circle" src="../picture/<?=$row['picture']?>" alt="User profile picture">
    </div>
    <!-- /.lockscreen-image -->
