...
$sql_ = "SELECT * FROM loads WHERE loads.id = '".$loadID."' ";
          ...
          <div class="col">
            <div class="card card-danger card-outline">
              <div class="card-header bg-primary">
                <h3 class="card-title"><b style="color:white;">DRIVER'S PAY ROLL</b></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               <form class="form" action="drivers_weekly_payroll.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <i class="fa fa-exclamation-circle" style="color:red;"></i> Kindly select date range to view Driver's report
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col text-center">
                      <input type="submit" name="view" class="btn btn-sm btn-primary" value="Generate Report">
                    </div>
                  </div>
                </div>
               </form>
          ...
          <div class="col">
            <div class="card card-danger">
                  ...
                  <tbody>
                    ...
                    <?php 
                      ...
                      if (isset($_POST['view'])) {
                          ...
                          $sql = "SELECT * FROM drivers_pay_roll WHERE drivers_pay_roll.driver_id = '".$row_["driver_id"]."' AND loads.paymentStatus = 0";
              ...
              <td><small class="badge badge-info"><?php echo $row['driver_id']?></small></td>
                    ...
                    <td> <a style="font-weight:bolder;" class="btn btn-sm" data-toggle="modal" data-target="#driver_workload_profile<?php echo $row['driver_id']?>"><?php echo $row['name']?></a></td>
                      ...
                      ?>
                         ...
                         <?php 
                          ...
                          echo "<a class='btn btn-sm btn-primary' data-toggle='modal' data-target='#editPayroll{$row["id"]}'><i class='fa fa-edit'></i></a> 

                            <a href=drivers_weekly_payroll.php?loadID=".$row['id']." class='btn btn-sm btn-info' style='font-weight: bolder;'><small><b>Make Payment</b></small></a>"; 

                        elseif($row["payrollStatus"] == 1) 
                          echo "<button disabled class='btn btn-sm btn-success'><i class='fa fa-check'></i></button>"; 
