       ...
       <div class="dropdown show nav-item d-none d-sm-inline-block" >
        ...
        <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkReport">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item active" href="registered_Load.php"> Registered Loads</a>
            <div class="dropdown-divider"></div>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;">REGISTERED LOADS</b></h3>
              </div>
              <div class="card-body">
                ...
                <table id="example1" class="table" style="font-size:13px;">
                  ...
                  <tbody>
                      ...
                      <tr>
                         ...
                         <td><?php echo $row['rate']; ?><sup style="color:green; font-weight: bolder;">USD</sup></td>
