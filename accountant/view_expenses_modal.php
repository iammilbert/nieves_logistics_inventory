 <div class="modal fade" id="expenses_details<?php echo $row["id"]; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="car card-primary">
              <form class="form">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group mb-3">
                    <label class="input-group-text bold">Type of Expenses</label> 
                            <input type="text" name="type" class="form-control" value="<?php echo $row["expensesType"]; ?>" readonly>
                    </div>
                  ...
                  <div class="input-group mb-3">
                   ...
                   <div class="input-group mb-3">
                    ...
                    <input type="text" name="amount" class="form-control text-right" value="<?php echo $row["amount"]; ?>" readonly>
               ...
               <div class="modal-footer justify-content-between bg-primary">
                  <button type="button" class="btn btn-outline-light btn-danger" data-dismiss="modal">Exit</button>
              </div>
              </form>
            </div>
