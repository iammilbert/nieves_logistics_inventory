              ...
              <div class="card card-danger"> <!-- New card --> 
                ...
                <div class="card-body"><!-- New body --> 
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT loads.rateConfirmationID, loads.rate, loads.netPay, vehicles_assigned.vehicle_id, vehicles.model FROM loads 
                    INNER JOIN vehicles_assigned 
                    ON vehicles_assigned.load_id = loads.id 
                    INNER JOIN vehicles 
                    ON vehicles_assigned.vehicle_id = vehicles.id WHERE loads.paymentStatus = 1 AND vehicles_assigned.vehicle_id = '".$vehicle_id."'";
...
<?php 
   if (isset($_POST['view'])) { 
    ...
    WHERE drivers_pay_roll.driver_id = '".$id."' AND loads.paymentStatus = 0  AND loads.dropped_Date  BETWEEN '".$from."' AND '".$end."'"; 
            ...
            <div class="col"><!-- New Col --> 
              <form class="form" ><!-- New Form --> 
                <div class="card-body"><!-- Card --> 
                  ...
                  <div class="row"> 
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="totalAmount" class="form-control" value="<?php echo round($id_row['sum'], 2);?>" disabled>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
            <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#makePayment<?php echo $id_row["driver_id"]; ?>"><small><b>Make Payment</b></small></a>
                  </div>
                </div>
            </form>
          </div> 
            ...
            <table id="example2" class="table" style="font-size:14px;"> 
              ...
              <tbody>
                  ...
                  <?php 
                    ...
                    ON drivers_pay_roll.load_id = loads.id 
                    INNER JOIN users 
                    ON drivers_pay_roll.driver_id = users.id WHERE loads.paymentStatus = 0 AND loads.driver_id = '".$id."' AND loads.dropped_Date  BETWEEN '".$from."' AND '".$end."'";
                ...
                ?>
                 <tr> 
                  <th>TOTAL AMOUNT</th> 
                  <th><small class="badge badge-info h1" style="font-size:19px;">$<?php echo round($id_row['sum'], 2);?></small></th>              
               </tr> 
                  </tbody>
                </table> 
              </div> 
