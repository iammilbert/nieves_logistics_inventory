       ...
       <div class="dropdown show nav-item d-none d-sm-inline-block" >
        ...
        <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkReport">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item active" href="registered_vehicles.php">Registered Vehicles</a>
            <div class="dropdown-divider"></div>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              ...
              <div class="modal-header">             
                    <h6 ><i class="fas fa-info" style="color:red;"></i> Click on vehicle type to delete record</h6>
              </div>
              <div class="card-body">
                ...
                <table id="example1" class="table" style="font-size:13px;">
                  ...
                  <tbody>
                      ...
                      <tr>
                         ...
                         <td><a class="deletebtn" name="delete" style="font-size:15px; font-weight: bolder;"><?php echo $row['vehicleType']; ?></a></td>
