                 ...
                 <div class="row text-center">
                   <div class="col">
                     <div class="form-group">
                      <a href="staff_payment_report.php" class="btn btn-lg btn-primary">Staff Report</a>
                     </div>
                   </div>
                   <div class="col">
                     <div class="form-group">
                   ...
                   <div class="col">
                     <div class="form-group">
                      <a href="drivers_payment_report.php" class="btn btn-lg btn-success"> Drivers Report</a>
                     </div>
                   </div>
                 </div>
               </form>
