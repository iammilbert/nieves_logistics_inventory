      ...
      <form class="form" action="makePayment_query.php" method="POST">
              ...
              <div class="input-group mb-3">
                 <div class="input-group-append">
                  ...
                  <input id="totalAmount" style="text-align:right; font-size: 28px; font-weight:bolder;" type="text" name="totalAmount" class="form-control" readonly value="<?php echo round($id_row['sum'], 2);?>">

                   <input type="hidden" name="grossPay" value="<?php echo round($id_row['sum'], 2);?>"> 
                   <input type="hidden" name="amountPaid" value="<?php echo round($id_row['sum'], 2);?>"> 
                ...
                <div class="input-group mb-3">
                 ...
                 <textarea class="form-control" name="comment"></textarea>    
                  ...
                  <input type="hidden" name="datePaid" class="form-control" value="<?php echo date("d/m/Y") ?>">
                ...
                <div class="input-group mb-3">
                 <div class="input-group-append">
                   ...
                   <h6 style="color:green;">Click on the checkbox to confirm. </h6>            
              </div>
