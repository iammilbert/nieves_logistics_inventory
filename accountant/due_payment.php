            ...
            <div class="card card-primary card-outline">     
              ...
              <div class="card-body">
               <form class="form">
                 ...
                 <div class="row text-center">
                   <div class="col">
                    <h2><i class="fa fa-arrow-down text-danger"></i></h2>
                   </div>
                 </div>
               </form>
              </div>
                 ...
                 <div class="row text-center">
                   <div class="col-md-4">
                     <div class="form-group">
                      <a href="staff_due_payment.php" class="btn btn-lg btn-primary"><i class="fa fa-users text-back"></i> Staff</a>
                     </div>
                   </div>
                   <div class="col-md-4">
                     <div class="form-group">
                   ...
                   <div class="col-md-4">
                     <div class="form-group">
                      <a href="drivers_due_payment.php" class="btn btn-lg btn-success"><i class="fa fa-truck text-back"></i> Drivers</a>
                     </div>
                   </div>
                 </div>
               </form>
