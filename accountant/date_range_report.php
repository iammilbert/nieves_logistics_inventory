  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-primary">
              <p class="modal-title" id="exampleModalLabel">Generate <b style="color:yellow;"><?php echo $row['name']?></b> Loads Due For Payment</p>
    ...
    <form class="form" action="drivers_weekly_payroll.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <i class="fa fa-exclamation-circle" style="color:red;"></i> Kindly select date range to view loads Delivered.
                    </div>
                  </div>
