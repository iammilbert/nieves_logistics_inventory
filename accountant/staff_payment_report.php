          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;">STAFF SALARIES REPORT</b></h3>
              </div>
              <div class="card-body">
                      <?php if (isset($_GET['error'])) { ?>
                        <div style="background:#FFD2D2; color: black; font-size: 20px;"><?php echo $_GET['error']; ?></div>
                      <?php } ?>
                ...
                <table id="example2" class="table" style="font-size:13px;">
                  <thead>
                   <tr>
                    <th>ID</th>
                    <th>NAME</th>
                  ...
                  <tbody>
                      ...
                      $sql="SELECT * FROM users WHERE users.role = 'Staff' OR users.role = 'Despatcher' OR users.role = 'Accountant'";
                      ...
                      <tr>
                        ...
                        <td>
                           <a class="btn btn-sm btn-info" href="staff_due_payment_report_details.php?staffId=<?php echo $row["id"]; ?>"><i class="fa fa-eye"></i></a>
