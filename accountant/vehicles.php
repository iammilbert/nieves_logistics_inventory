      ...
      <div class="dropdown show nav-item d-none d-sm-inline-block" >
       ...
       <div class="dropdown show nav-item d-none d-sm-inline-block" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkVehicles">
            <a class="dropdown-item active" href="vehicles.php">Register Vehicle</a>
            <div class="dropdown-divider"></div>
          ...
          <div class="col">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title"><b style="color:red;">REGISTERED VEHICLES</b></h3>
              </div>
<!-- 
              <div class="modal-header">             
                <h6 ><i class="fas fa-info" style="color:red;"></i> You can also click on Truck Number to Delete Truck Record</h6>
              </div> -->

               <div class="card-body ml-auto">
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary"><span class="fas fa-plus" name="addtruck"></span> Vehicle</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                   ...
                   <?php
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-sm btn-primary"data-toggle="modal" type="button" data-target="#vehicle_update_Modal<?php echo $row['id']?>"><span class="fas fa-edit"></span></button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header bg-primary">
              <h4 class="modal-title" id="staticBackdropLabel">Vehicle Registration</h4>
            ...
            <div class="car card-primary">
                         <!-- form start -->
              <form class="form" action="signup_vehicle_query.php" method="POST">
                <div class="card-body">
                <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                           ...
                           <input type="text" class="form-control" name="number" required="number" placeholder="Enter vehicle number">
                        </div>

                         <div class="input-group mb-3">
                           <label class="input-group-text">VIN</label>
                           <input type="text" class="form-control" name="vin" required="vin" placeholder="Enter vehicle VIN">
                         ...
                         <div class="input-group mb-3">
                           ...
                           <input type="text" class="form-control" name="model" required="model" placeholder="Enter vehicle Model">
              ...
              <div class="modal-footer justify-content-between bg-primary">
                <button type="button" class="btn btn-outline-light btn-danger" data-dismiss="modal">Cancel</button>
                  <input type="submit" name="register" class="btn btn-outline-light btn-primary">
