...
<html lang="en">
  ...
  <title class="center">Profile</title>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
   <!-- Brand Logo -->
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><b class="text-green bold"><?php echo $row_company["name"]; ?></b>
        </span>
    </a>
        ...
        <div class="row mb-2">
          <div class="col">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item"><a href="_print_users_profile.php?userID=<?php echo $row["id"]; ?>" class="btn btn-sm btn-primary"> <i class="fa fa-print"></i> Print</a></li>
            </ol>
          </div>
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid"
                       src="uploadLogo/<?=$row_company['logo']?>"
                       alt="User profile picture" style="width: 100px; height: 50px;">
                </div>



                <h3 class="profile-username text-center"><b><?php echo $row["name"]; ?></b></h3>
                <h5 class="profile-username text-center" style="font-size:13px;"><i class="fas fa-map-marker-alt mr-1" style="color:red;"></i><?php echo $row["address"]; ?></h5>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                   ...
                   <li class="list-group-item">
                    ...
                    if ($row["role"]=="Admin" OR $row["role"]=="Accountant" OR $row["role"]=="Despatcher") {
                      echo "<b>Salary</b> <a class='float-right'>{$row["salary"]}<b>USD</b></a>";
                    }
                    else
