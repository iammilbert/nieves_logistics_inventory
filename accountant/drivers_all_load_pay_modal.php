<div class="modal fade" id="drivers_all_loads<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form class="form" action="drivers_all_load_paid.php" method="POST">
                <div class="modal-body">
                    <div class="col">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" name="datePaid" class="form-control" value="<?php echo $row["datePaid"]; ?>">
                    ...
                    <div class="col text-center">
                       <div class="form-group">
                         <input type="submit" name="submit" value="View Loads" class="btn btn-sm btn-flat btn-info">
                      </div>
